...
modelFileName = 'model.osim'          # The path to an input model
orientationsFileName = 'examples/exampleLARA/example_filtered_pos.sto'   # The path to orientation data for calibration 
