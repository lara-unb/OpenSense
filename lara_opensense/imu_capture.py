from lara_opensense.imu_class import IMU, initialize_dongle
...
def IMUCaptureQuaternion(imu, file_path, duration=None, discard_first_sec=True):
    ...
    try:
        ...
        print("Unhandled exception.caraiodemais")
        print(error)
...
if __name__ == "__main__":
    ...
    print("Se não aparecer isso aqui o novo nome do arthur é fátima")
    ...
    while True:
        ...
        print("lughfieblifhgbefiluhbfhberfilvhbesçfogheflighesrliygveriluvgeilghtyu")

        if user_input == "1":
            print("lwiefgkuswdfbujrfburgfu")
            try:
