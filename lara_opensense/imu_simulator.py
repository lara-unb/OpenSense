...
if __name__ == '__main__':
    ...
    # json_file = 'testes/trike_test_wrong.json' # yzx
    # json_file = 'testes/trike_test_ok.json' # zyx
    # json_file = 'testes/mov_arm.json' # zyx
    # json_file = 'testes/mov_5imus.json' # zyx
    # json_file = 'testes/mov_board_test.json' # yzx
    json_file = 'oioi.json'
    ...
    #                     parent=seg_femur_r, length=25, initial_angle_deg=None)
    ...
    # fig, ax = plt.subplots()
    # ax.plot(time, df_angles_abs['imu_1_x'], label='imu_1_x_abs')
    # ax.plot(time, df_angles_abs['imu_1_y'], label='imu_1_y_abs')
    # ax.plot(time, df_angles_abs['imu_1_z'], label='imu_1_z_abs')
    # ax.plot(time, df_angles_abs['imu_2_x'], label='imu_2_x_abs')
    # ax.plot(time, df_angles_abs['imu_2_y'], label='imu_2_y_abs')
    # ax.plot(time, df_angles_abs['imu_2_z'], label='imu_2_z_abs')
    # ax.legend()
    # ax.grid()

    # fig, ax = plt.subplots()
    # ax.plot(time, df_angles_rel['imu_1_x'], label='imu_1_x')
    # ax.plot(time, df_angles_rel['imu_1_y'], label='imu_1_y')
    # ax.plot(time, df_angles_rel['imu_1_z'], label='imu_1_z')
    # ax.legend()
    # ax.grid()
    # ax.set_aspect('equal')
    # plt.show()
